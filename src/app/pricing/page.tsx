...
import PricingPlanActionButton from './components/PricingPlanActionButton';
...
const benchmarkNotes = [
  {
    ...
    detail:
      'Public 2026 benchmarks show entry plans around $8–$10, mid tiers around $22–$29, and growth tiers around $69–$75.',
  },
  {
    label: 'India SaaS expectations',
    detail:
      'India-friendly annual pricing benchmarks like Zoho Social often land near ₹600, ₹1,725, and ₹2,595 for SMB-friendly plans.',
  },
  {
    label: 'LinkLab approach',
    detail:
      'We keep the starter plan accessible for Indian teams while pricing growth tiers against global alternatives like Bitly, Dub, and Rebrandly.',
  },
] as const;

const compareRows = [
  { feature: 'New links / month', free: '5', launch: '500', growth: '5K', scale: '25K' },
            ...
            <div className="grid gap-12 lg:grid-cols-[1.05fr_0.95fr] items-center">
              <div>
                ...
                <p className="max-w-[650px] font-body text-lg lg:text-xl leading-relaxed text-white/58 mb-10">
                  We benchmarked public 2026 pricing from Bitly, Dub, Rebrandly, and India-friendly
                  SaaS plans to build tiers that feel competitive globally while staying accessible
                  for Indian founders and growing teams.
                </p>
              ...
              <div className="rounded-[30px] p-6 lg:p-8" style={glassCardStyle}>
                ...
                <div className="space-y-4">
                  {[
                    [
                      'Entry plans',
                      'Bitly Core $10 · Rebrandly Essentials $8 · Zoho Social Standard ₹600',
                    ],
                    [
                      'Mid-market',
                      'Dub Pro $25 · Rebrandly Professional $22 · Zoho Social Professional ₹1725',
                    ],
                    [
                      'Growth tiers',
                      'Dub Business $75 · Rebrandly Growth $69 · Zoho Social Premium ₹2595',
                    ],
                    [
                      'LinkLab recommendation',
                      'Launch at ₹499 / $6 and Growth at ₹1,999 / $24 to stay attractive in both markets',
                    ],
                  ].map(([label, detail]) => (
                    <div
                      key={label}
                    ...
                    >
                      <div className="font-body text-xs uppercase tracking-[0.14em] text-white/35 mb-1">
                        {label}
                      </div>
                      <div className="font-body text-sm leading-relaxed text-white/58">
                        {detail}
                      </div>
                    </div>
                  ))}
          ...
          <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-[640px] mb-14">
              ...
              <h2 className="font-heading text-4xl lg:text-5xl font-bold mb-4">
                Simple pricing with room to scale
              </h2>
              <p className="font-body text-lg text-white/52 leading-relaxed">
                Use the free plan to explore, start affordably in INR, or scale with globally
                competitive analytics and team controls.
              </p>
            </div>
              ...
              {billingPlans.map((plan) => (
                ...
                >
                  <div className="flex items-start justify-between gap-4 mb-5">
                    ...
                    {plan.featured && (
                      <div
                        className="px-3 py-1.5 rounded-full text-xs font-semibold text-amber-200"
                        style={{
                  ...
                  <div className="mb-6">
                    ...
                    <div className="font-body text-sm text-white/40">
                      or {plan.usd}
                      {plan.cadence} · billed annually · {plan.seats}
                    </div>
                  </div>
            ...
            <div className="grid gap-10 lg:grid-cols-[0.88fr_1.12fr] items-start">
              <div>
                ...
                <h2 className="font-heading text-4xl lg:text-5xl font-bold leading-tight mb-5">
                  The features that change as your team grows
                </h2>
                <p className="font-body text-lg leading-relaxed text-white/52 max-w-[540px]">
                  The plan structure stays intentionally clear: more links, deeper analytics,
                  stronger collaboration, and better automation as usage increases.
                </p>
              </div>

              <div className="rounded-[28px] overflow-hidden" style={glassCardStyle}>
                <div
                  className="grid grid-cols-5 gap-0 px-5 py-4 text-xs uppercase tracking-[0.14em] text-white/38"
                ...
                >
                  Need SSO, audit trails, custom SLAs, or far higher limits? The `Scale` and
                  enterprise path are designed for that.
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="relative overflow-hidden py-24 lg:py-28" style={sectionDividerStyle}>
          <div className="max-w-[900px] mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-14">
              ...
              <p className="font-body text-lg text-white/52 leading-relaxed">
                A few quick answers about how the plan structure was researched and how the billing
                is positioned.
              </p>
            </div>

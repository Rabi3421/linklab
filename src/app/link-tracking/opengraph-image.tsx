      ...
      >
        <div
          style={{
            ...
            inset: 0,
            background:
              'radial-gradient(circle at 20% 20%, rgba(245,158,11,0.22), transparent 34%), radial-gradient(circle at 82% 20%, rgba(99,102,241,0.18), transparent 32%), radial-gradient(circle at 58% 85%, rgba(16,185,129,0.14), transparent 36%)',
          }}
        />
        <div
          style={{
        ...
        >
          ...
          >
            Link Tracking & URL Analytics for Every Click
          </div>

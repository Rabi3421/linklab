        ...
        <div className="space-y-6">
          <section className="bg-card rounded-lg border border-border p-6">
            <div className="mb-5">
              ...
              <p className="text-sm text-muted-foreground">Update how your name and workspace appear across LinkLab.</p>
            </div>
          ...
          <section className="bg-card rounded-lg border border-border p-6">
            <div className="mb-5">
              ...
              <p className="text-sm text-muted-foreground">Choose which updates reach your inbox.</p>
            </div>
            ...
            <div className="space-y-4">
              <label className="flex items-center justify-between rounded-lg border border-border bg-muted/40 px-4 py-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Get a digest of top-performing links and campaigns.</p>
                </div>
                <input type="checkbox" checked={emailReports} onChange={(event) => setEmailReports(event.target.checked)} className="h-4 w-4" />
              </label>

              <label className="flex items-center justify-between rounded-lg border border-border bg-muted/40 px-4 py-4">
                <div>
                  <p className="text-sm font-medium text-foreground">Security alerts</p>
                  <p className="text-xs text-muted-foreground">Be notified when sessions refresh from new browsers or devices.</p>
                </div>
                <input type="checkbox" checked={securityAlerts} onChange={(event) => setSecurityAlerts(event.target.checked)} className="h-4 w-4" />
              </label>
            </div>
        ...
        <aside className="space-y-6">
          ...
          <section className="bg-card rounded-lg border border-border p-6">
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li className="flex items-start gap-2"><Icon name="CheckCircleIcon" size={18} variant="solid" className="text-success mt-0.5" />Branded short domain recommended for public campaigns</li>
              <li className="flex items-start gap-2"><Icon name="CheckCircleIcon" size={18} variant="solid" className="text-success mt-0.5" />Use lowercase UTM values for clean reporting</li>
              <li className="flex items-start gap-2"><Icon name="CheckCircleIcon" size={18} variant="solid" className="text-success mt-0.5" />Expire time-sensitive promotional links automatically</li>
            </ul>
          </section>
        </aside>
      </div>
